...
// decoded by pkg/cwlcore, and the resulting pass count is ratcheted so a regression
// fails the build.
//
...
//	CWL_CONFORMANCE_UPDATE=1       rewrite testdata/stage0-ratchet.json from the observed result
//
